import { Globe, Mail, MapPin, MessageCircle, Phone, Users } from 'lucide-react'
import './Contact.css'
    ...
    <div className='contact-page'>
      <header className='page-header'>
        <div className='container'>
          <h1>Contact Us</h1>
          <p>
            Get in touch with the National Secretariat, School of Hygiene, Korle
            Bu Accra for inquiries and support.
          </p>
        </div>
      </header>
          ...
          <div className='grid grid-cols-2 align-start'>
            <div className='contact-info-col'>
              <h2 className='section-title mb-8'>
                National Secretariat, School of Hygiene, Korle Bu Accra
              </h2>
              ...
              <div className='contact-card mb-6 card border-green'>
                ...
                <div>
                  ...
                  <p className='text-muted mb-2'>
                    For all official correspondence and inquiries.
                  </p>
                  <a
                    href='mailto:cohtag@gmail.com'
                    className='contact-link font-bold text-lg'
                  >
                    cohtag@gmail.com
                  </a>
                </div>
              ...
              <div className='card'>
                ...
                <form>
                  ...
                  <button
                    ...
                    onClick={() =>
                      alert('Message sending will be enabled soon.')
                    }
                  >
                    Send Message
                  </button>
