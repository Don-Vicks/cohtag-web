...
const Membership = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      for (const [key, file] of Object.entries(files)) {
        if (file) {
          try {
            ...
            if (
              err.message === 'Cloudinary configuration missing' &&
              import.meta.env.DEV
            ) {
      ...
      const apiEndpoint =
        import.meta.env.VITE_RESEND_API_ENDPOINT || '/api/submit-membership'
          ...
          <div className='grid grid-cols-2'>
            <div className='info-column'>
              ...
              <div className='card mb-8'>
                <p>
                  Membership is open to all tutors and educators actively
                  teaching in accredited health training institutions across
                  Ghana. This includes nurses, midwives, allied health
                  professionals, and other specialized tutors recognized by the
                  Ministry of Health.
                </p>
              </div>
              ...
              <div className='card mb-8'>
                <ul className='info-list'>
                  ...
                  <li>
                    <CheckCircle size={20} className='text-accent' /> Vote and
                    be voted for into executive positions.
                  </li>
                  <li>
                    <CheckCircle size={20} className='text-accent' /> Access to
                    COHTAG welfare schemes and financial assistance programs.
                  </li>
                  <li>
                    <CheckCircle size={20} className='text-accent' /> Benefit
                    from negotiated conditions of service and advocacy.
                  </li>
                  <li>
                    <CheckCircle size={20} className='text-accent' />{' '}
                    Participate in subsidized capacity building and training
                    programs.
                  </li>
                  <li>
                    <CheckCircle size={20} className='text-accent' /> Legal and
                    professional representation in matters relating to
                    employment.
                  </li>
                </ul>
              </div>
            ...
            <div className='info-column'>
              ...
              <div className='card mb-8'>
                <ul className='info-list'>
                  <li>
                    <CheckCircle size={20} className='text-secondary' /> Pay
                    dues, levies, and contributions promptly.
                  </li>
                  <li>
                    <CheckCircle size={20} className='text-secondary' /> Attend
                    branch, zonal, and national meetings regularly.
                  </li>
                  <li>
                    <CheckCircle size={20} className='text-secondary' /> Uphold
                    and defend the constitution of COHTAG.
                  </li>
                  <li>
                    <CheckCircle size={20} className='text-secondary' /> Protect
                    the image and integrity of the association.
                  </li>
                </ul>
              </div>
              ...
              <div className='card'>
                <p className='mb-4'>
                  Members are expected to demonstrate the highest level of
                  professionalism, integrity, and dedication to duty. Tutors
                  must:
                </p>
                <ul className='info-list'>
                  <li>
                    <CheckCircle size={20} className='text-secondary' /> Serve
                  ...
                  <li>
                    <CheckCircle size={20} className='text-secondary' />{' '}
                    Continuously update their knowledge and pedagogical skills.
                  </li>
                  <li>
                    <CheckCircle size={20} className='text-secondary' /> Foster
          ...
          <div className='form-container'>
            <div className='text-center mb-8'>
              ...
              <p className='section-subtitle'>
                Complete the form below to register as a member of COHTAG
              </p>
            </div>
            ...
            {submitStatus === 'success' ? (
              <div className='success-message card border-green text-center py-12'>
                ...
                <h3 className='text-2xl mb-2 text-primary'>
                  Registration Submitted!
                </h3>
                <p>
                  Your membership application has been received successfully.
                  The National Secretariat, School of Hygiene, Korle Bu Accra
              ...
              <form
                ...
                className='registration-form card border-gold'
              >
                {submitStatus === 'error' && (
                ...
                <div className='form-section declaration-section'>
                  <label className='checkbox-wrapper'>
                    ...
                    <span className='checkbox-text'>
                      ...
                      accurate to the best of my knowledge. I agree to abide by
                      the Constitution and Code of Ethics of the Colleges of
                      Health Teachers' Association of Ghana (COHTAG).
                    </span>
                  </label>
                </div>
                ...
                <div className='form-actions mt-8'>
                  ...
                  <p className='text-center text-sm text-muted mt-4'>
                    Your data is secure and will only be used for official
                    COHTAG membership purposes.
                  </p>
                </div>
              </form>
            )}
